...
{
    const string OpenSplitViewChar = ">";
    const string CloseSplitViewChar = "<";

    [ObservableProperty]
    private bool _openSplitView = false;

    [ObservableProperty]
    private string _openSplitViewButtonContent = OpenSplitViewChar;

    public void ChangeSplitView() => OpenSplitView = !OpenSplitView;

    partial void OnOpenSplitViewChanged(bool oldValue, bool newValue)
    {
        OpenSplitViewButtonContent = newValue ? CloseSplitViewChar : OpenSplitViewChar;
    }

    public void ShowSettingsWindow()
    {
        var settingsView = new SettingsWindow();
        settingsView.ShowDialog(App.MainWindow!);
    }
